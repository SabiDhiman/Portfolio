...
const SocialIcons = (props) => {
    return (
        <Icons>
            ...
            >
                <NavLink style={{color:'inherit'}}  target="_blank"   to={{pathname:"https://github.com/SabiDhiman"}}>
            ...
            >
                <NavLink style={{color:'inherit'}}  target="_blank"   to={{pathname:"https://www.linkedin.com/in/sabi-dhiman-477650218/"}}>
